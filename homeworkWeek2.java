...
System.out.println (age >= 16);{
	...
	if (age >= 16 && licensed) { 	System.out.println ("you should be able to drive");
	} else {
				
				System.out.println ("please wait till older");
	   ...
	   if (costOfMilk < 2.5 || thirstlevel > 7) {
		   System.out.println("more milk");
	   } else { System.out.println (enough milk);
...
if (cookies % children >= 5 ); { 
	System.out.println("jackpot!");
} else if (cookies % children >= 2); {
System.out.println("yippey");
else if (cookies % children > 0) { 
